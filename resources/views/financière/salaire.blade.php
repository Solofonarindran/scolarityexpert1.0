                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="row">
                            <div class="col-lg-5" style="">
                                ...
                                <div class="panel pb-3 p-3" style=""> 
                                    <div class="row align-items-center">
                                        <div class="col-4">
                                            <div class="img-profile mb-3">
                                                <img src="/assets/img/demo/avatars/avatar-a.png" class="mt-2 rounded-pill" width="100%" alt=""
                                                    srcset="" />
                                            </div>
                                        </div>
                                        <div class="col-8">
                            ...
                            <div class="col-lg-7">
                                ...
                                <div class="panel">
                                    <div class="row mb-3 align-items-center py-3">
                                        <div class="col-lg-12">
                                            <div class="d-flex align-items-center justify-content-center">
                                                <div>
                                                    <button class="btn btn-outline-success mr-3" data-toggle="modal" data-target=".example-modal-right-transparent">
                                                        Payement
                                                    </button>
                                                </div>
                                                <div>
            ...
            <div class="modal-dialog modal-dialog-right modal-sm modal-transparent">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title h4 text-white">Payement de Salaire</h5>
