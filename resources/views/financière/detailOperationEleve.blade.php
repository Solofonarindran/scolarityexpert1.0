@extends('layout')
    ...
    @section('badge')
        <sup class='badge badge-warning fw-800' style="letter-spacing:2px;font-size:12px">Détails Opérations</sup>
    @endsection
    ...
    <div class="container">
        <div data-size="A4">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="table-responsive">
                         <h4><span class="badge badge-warning">Détails</span></h4>
                        <table class="table mt-5">
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <th class="text-center fw-700">Heure d'action </th>
                                    <th class="text-center fw-700"> Montant </th>
