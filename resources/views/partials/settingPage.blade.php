                        ...
                        <div class="mt-2 d-table w-100 pl-5 pr-3">
                            <div class="d-table-cell align-middle">
                                ...
                                <div class="fs-xs text-muted p-2 alert alert-warning mt-3 mb-0">
                                    ...
                                    and CPU utilization, you may
                                    experience a brief flickering effect on page load which may
                                    show the intial applied theme for a split second. Setting
                                    the prefered style/theme in the header will prevent this
                                    from happening.
                                </div>
                            </div>
                        </div>
