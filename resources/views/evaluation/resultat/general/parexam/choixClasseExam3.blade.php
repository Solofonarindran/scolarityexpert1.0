@extends('layout')
    ...
    @section('style')
        <link rel="stylesheet" href="/assets/css/custom-css/evaluation_parexam.css">
    @endsection
    ...
    @section('contents')
        ...
        <div class="gestion-inscription-etape-2">  
            ...
            <div class="choix-cycle shadow-lg">
                ...
                <form action="{{route('postClasseExamResultat')}}" method="POST" class="form-select">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <select name="examen_id" class="form-control" id="exampleFormControlSelect1">
                            @foreach ( $examens as $examen)
                                  <option value="{{$examen->id}}">{{$examen->examen_title}}</option>
                            @endforeach
