@extends('layout')
    ...
    @section('badge')
        <sup class='badge badge-warning fw-800' style="letter-spacing:2px;font-size:12px">Bulletin Numérique</sup>
    @endsection
        ...
        <div data-size="A4">
            ...
            <div class="row">
                ...
                <div class="col-sm-4 ml-sm-auto">
                    <div class="table-responsive">
                        <table class="table table-sm table-clean align-self-end">
                            <tbody>
                                <tr>
                                    <td>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="table-responsive">
                         <h4><span class="badge badge-warning">Rélevés de note</span></h4>
                        <table class="table mt-5">
                            <thead>
                                <tr BORDER=2>
                                    <th class="text-center"></th>
                                    <th class="text-center"></th>
                                    <th class="text-center fw-700" COLSPAN=2>TRIMESTRE I</th>
                                    <th class="text-center fw-700" COLSPAN=2>TRIMESTRE II</th>
                                    <th class="text-center fw-700" COLSPAN=2>TRIMESTRE III</th>
                                    
                                </tr>
                                <tr>
                                    <th class="text-center fw-700 table-scale-border-right">Matière</th>
                                    <th class="text-center fw-700">Coeff</th>
                                    <th class="text-center fw-700">Inter</th>
                                    <th class="text-center fw-700">Examen</th>
                                    <th class="text-center fw-700">Inter</th>
                                    <th class="text-center fw-700">Examen</th>
                                    <th class="text-center fw-700">Inter</th>
                                    <th class="text-center fw-700">Examen</th>
                        ...
                        <table class="table mt-5">
                            <thead>
                                <tr>
                                  ...
                                  <th class="text-center fw-700" COLSPAN=2>Trim I</th>
                                  <th class="text-center fw-700" COLSPAN=2>Trim II</th>
                                  <th class="text-center fw-700" COLSPAN=2>Trim III</th>
                                </tr>
                                <tr>
                                    <th class="text-center fw-700"></th>
                        ...
                        <table class="table mt-5">
                            <thead>
                                <tr>
                                  ...
                                  <th class="text-center fw-700" COLSPAN=2>Vues et Signés</th>
                                </tr>
                                <tr>
                                
                                    <th class="text-center fw-700">Parent/Titeur</th>
                                    <th class="text-center fw-700">Titulaire</th>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="py-5 text-muted">
                        Vu et approuvé, Mme SOAZARA Mbaraky
                    </h4>
                    <p class="mt-2 text-muted mb-0">
                        Contact Administration: <i class="fal fa-phone">+261 34 7 500642</i>
                    </p>
                </div>
            </div>
        </div>
