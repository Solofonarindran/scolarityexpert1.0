           ...
           <!--<h1 class="choix-title">Inscription</h1> -->
            <div class="choix-cycle shadow-lg">
                ...
                <div class="choix-action">
                    <a href="" class="btn btn-sm btn-outline-success d-flex align-items-center" style="height:auto;margin:10px; letter-spacing:2px;font-weight:800" >
                        <i class="fa-2x fal fa-plus-square mr-2"></i>Nouveau
                        
                    </a>
                   
                    <a href="" class="btn btn-outline-warning d-flex align-items-center" style="height:auto;margin:10px; letter-spacing:2px;font-weight:800">
                         <i class="fa-2x fas fa-edit mr-2"></i>Réclamation
                    </a>

                    <a href="" class="btn btn-outline-danger d-flex align-items-center" style="height:auto;margin:10px; letter-spacing:2px;font-weight:800">
